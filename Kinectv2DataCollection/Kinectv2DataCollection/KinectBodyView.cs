...
namespace Kinectv2DataCollection
{
    ...
    public sealed class KinectBodyView
    {
        ...
        /// Brush used for drawing hands that are currently tracked as in lasso (pointer) position
        /// </summary>
        private readonly Brush handHighConfidence = new SolidColorBrush(Color.FromArgb(128, 0, 255, 255));

        /// <summary>
        /// Brush used for drawing hands that are currently tracked as in lasso (pointer) position
        /// </summary>
        private readonly Brush handLowConfidence = new SolidColorBrush(Color.FromArgb(128, 198, 226, 255));
        ...
        /// </summary>
        public List<Pen> bodyColors { get; set; }
        ...
        public KinectBodyView(KinectSensor kinectSensor)
        {
            ...
            this.bodyColors.Add(new Pen(Brushes.Red, 5));
                ...
                using (DrawingContext dc = this.drawingGroup.Open())
                {
                    ...
                    foreach (Body body in bodies)
                    {
                        ...
                        if (body.IsTracked)
                        {
                            ...
                            this.DrawHand(body.HandLeftState, jointPoints[JointType.HandLeft], dc, body.HandLeftConfidence.ToString());
                            this.DrawHand(body.HandRightState, jointPoints[JointType.HandRight], dc, body.HandRightConfidence.ToString());
                        }
                    }
        ...
        /// <param name="drawingContext">drawing context to draw to</param>
        private void DrawHand(HandState handState, Point handPosition, DrawingContext drawingContext, string confidence)
        {
            if (confidence.Equals("High"))
            {
                drawingContext.DrawEllipse(this.handHighConfidence, null, handPosition, HandSize, HandSize);
                switch (handState)
                {
            ...
            {
                drawingContext.DrawEllipse(this.handLowConfidence, null, handPosition, HandSize, HandSize);
            }
        }
